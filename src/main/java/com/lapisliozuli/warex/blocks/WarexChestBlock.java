...
public class WarexChestBlock extends AbstractChestBlock<ChestBlockEntity> implements Waterloggable {
    ...
    protected WarexChestBlock(AbstractBlock.Settings settings, Supplier<BlockEntityType<? extends ChestBlockEntity>> supplier) {
    ...
    @Nullable
    public static Inventory getInventory(WarexChestBlock block, BlockState state, World world, BlockPos pos, boolean ignoreBlocked) {
    ...
    public DoubleBlockProperties.PropertySource<? extends ChestBlockEntity> getBlockEntitySource(BlockState state, World world, BlockPos pos, boolean ignoreBlocked) {
        ...
        return DoubleBlockProperties.toPropertySource((BlockEntityType)this.entityTypeRetriever.get(), WarexChestBlock::getDoubleBlockType, WarexChestBlock::getFacing, FACING, state, world, pos, biPredicate2);
    }
